...
export class AddEventComponent implements OnInit, OnDestroy {
  ...
  onSubmit(form: NgForm) {
    ...
    // const event = new EventModel(type, amount, +category, dateStr, description);
      ...
      .subscribe((bill: Bill) => {
        ...
        if (type === 'outcome') {
          if (amount > bill.value) {
            this.showMessage(`На счету не достаточно средств. Вам нехватает ${amount - bill.value}.`);
            return;
          } else {
